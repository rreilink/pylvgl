...
""".format(func=func.name, 
    ...
    def customize(self):
        ...
        for name in 'BORDER SHADOW DESIGN RES SIGNAL PROTECT ALIGN ANIM ARC_STYLE LAYOUT INDEV_TYPE INDEV_STATE BTN_STATE BTN_ACTION BTN_STYLE TXT_FLAG TXT_CMD_STATE LABEL_LONG LABEL_ALIGN BAR_STYLE BTNM_STYLE CB_STYLE CHART_TYPE SB_MODE PAGE_STYLE DDLIST_STYLE FS_RES FS_MODE IMG_SRC IMG_CF KB_MODE KB_STYLE LIST_STYLE MBOX_STYLE PRELOAD_STYLE ROLLER_STYLE SLIDER_STYLE SW_STYLE WIN_STYLE TABVIEW_BTNS_POS TABVIEW_STYLE CURSOR TA_STYLE'.split():
